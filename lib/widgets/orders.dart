      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text("Запланированная дата: $scheduledDate",
...
class _OrderListState extends State<OrderList> {
  ...
  Future _updateOrders(String accessToken) async {
    getProductOrders(accessToken, _orders.length, batchSize).then((orders) => {
          setState(() {
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels ==
      ...
      makeRequestWithAuth(context, _updateOrders);
    }
  }
